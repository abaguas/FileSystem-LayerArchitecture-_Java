...
public class ListDirectoryTest extends AbstractServiceTest{
	...
	protected void populate(){
	    ...
	    new App("Application", 123, u1, "con.teu.do1", home_user);
	   	...
	   	Session s3 = new Session("EusebioSilva", "grandepass1", sm);
	   	token3=s3.getToken();
	...
	@Test
	public void PermitedListDirectoryThroughRelativeAbsolutePath() throws NoSuchFileException{
        ListDirectoryService service = new ListDirectoryService(token3, "home/EusebioSilva");
        service.execute();
	...
	@Test
	public void PermitedListDirectoryThroughAbsolutePath() throws NoSuchFileException{
        ListDirectoryService service = new ListDirectoryService(token1, "/home/EusebioSilva");
        service.execute();
        List<FileDto> cs = service.result();
    ...
    public void invalidToken() { //Testing CD with an invalid token
		...
		while (token == token1 || token == token2 || token == token3){
